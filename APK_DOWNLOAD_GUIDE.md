...
>
> **iOS User?** Check the [iOS Download & Testing Guide](IOS_DOWNLOAD_GUIDE.md) for instructions on
> using BrowserStack cloud simulation.
...
*
⬇️ [Download Latest APK](https://github.com/devmilang99/NeRuWallet/releases/latest/download/NeRuWallet-Android.apk)
**
...
1. **Download the APK**
    - Click the *
      *[Latest Download Link](https://github.com/devmilang99/NeRuWallet/releases/latest/download/NeRuWallet-Android.apk)
      **.
...
3. **Install the Application**
    ...
    - Tap on the `NeRuWallet-Android.apk` file.
...
adb install path/to/NeRuWallet-Android.apk
...
4. Drag and drop the downloaded `NeRuWallet-Android.apk` onto the device screen.
...
| **EXTERNAL_STORAGE**   | Store encrypted transaction backups and app logs           |
