...
import '../../../auth/presentation/pages/transaction_pin_screen.dart';
...
class _PayBillScreenState extends ConsumerState<PayBillScreen> {
  ...
  void _onPay() async {
    ...
    // Trigger Security Validation before processing
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => TransactionPinScreen(
          mode: PinMode.verify,
          onSuccess: () => _executeBillPayment(amount, customerCode),
        ),
      ),
    );
  }

  void _executeBillPayment(double amount, String customerCode) async {
    // 1. Close PIN screen
